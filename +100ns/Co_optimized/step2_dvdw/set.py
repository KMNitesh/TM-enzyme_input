...
#for a in [200,250,300,350,400,450,500,550,600]:
  os.system("rm -r %s_dvdw_repe"%(a))
  os.system("cp -r temp/ %s_dvdw_repe"%(a))
  adir=dir+ "%s_dvdw_repe/"%(a)
  os.chdir(adir)
  ...
  os.chdir(sdir)
  i=0
  os.system("cp /mnt/gs18/scratch/users/songlin3/run/glx-0904/+100ns/Co_optimized/step1_dc/%s_dc_repe/1.0/%s_1.0_eq_center.rst ."%(a,a))
  os.system("mv eq.in %s_eq.in"%(i))
  os.system("mv us.in %s_us.in"%(i))
  os.system("sed -i 's/XXX/%s/g' %s_eq.in"%(i,i))
  os.system("sed -i 's/XXX/%s/g' %s_us.in"%(i,i))
