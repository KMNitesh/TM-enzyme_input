...
for i in [150,200,250,300,350,400,450,500,550,600]:
  ...
  os.system("cpptraj -p glx-ni_1264_final.prmtop < all.in > out")
  os.system("cp %s_all_us_center.netcdf ../../netcdf/%s/step1/"%(i,i))
  os.system("cp glx-ni_1264_final.prmtop ../../netcdf/%s/step1/"%(i))
